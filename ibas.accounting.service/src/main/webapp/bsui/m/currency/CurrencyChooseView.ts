...
namespace accounting {
    export namespace ui {
        export namespace m {
            /** 选择视图-货币 */
            export class CurrencyChooseView extends ibas.BOChooseView implements app.ICurrencyChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Currency;
                }
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_currency_code"),
                                        bindingValue: {
                                            path: "code",
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_currency_name"),
                                        bindingValue: {
                                            path: "name",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_currency_activated"),
                                        bindingValue: {
                                            path: "activated",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_currency_iso"),
                                        bindingValue: {
                                            path: "iso",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_currency_foreignname"),
                                        bindingValue: {
                                            path: "foreignName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_currency_remarks"),
                                        bindingValue: {
                                            path: "remarks",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }

...
namespace accounting {
    export namespace ui {
        export namespace c {
            /** 列表视图-日记账分录 */
            export class JournalEntryListView extends ibas.BOListView implements app.IJournalEntryListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.JournalEntry;
                }
                /** 编辑数据，参数：目标数据 */
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_journalentry_docentry"),
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.JournalEntry.BUSINESS_OBJECT_CODE
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_journalentry_documentdate"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_journalentry_documenttotal"),
                                template: new sap.extension.m.ObjectNumber("", {
                                    number: {
                                        path: "documentTotal",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_journalentry_branch"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_journalentry_dataowner"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_journalentry_remarks"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "remarks",
                                    type: new sap.extension.data.Alphanumeric(),

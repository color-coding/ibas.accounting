...
namespace accounting {
    export namespace ui {
        export namespace c {
            /** 列表视图-分支 */
            export class BranchListView extends ibas.BOListView implements app.IBranchListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Branch;
                }
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_branch_code"),
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.Branch.BUSINESS_OBJECT_CODE
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_branch_name"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_branch_activated"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "activated",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_branch_main"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "main",
                                    type: new sap.extension.data.YesNo(true),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_branch_remarks"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "remarks",
                                    type: new sap.extension.data.Alphanumeric(),

...
namespace accounting {
    export namespace ui {
        export namespace c {
            /** 编辑视图-费用项目 */
            export class CostItemEditView extends ibas.BOEditView implements app.ICostItemEditView {
                /** 删除数据事件 */
                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_costitem_code") }),
                            ...
                            new sap.extension.m.SeriesSelect("", {
                                objectCode: bo.BO_CODE_COSTITEM,
                            }).bindProperty("bindingValue", {
                                path: "series",
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_costitem_name") }),
                            new sap.extension.m.Input("", {
                            }).bindProperty("bindingValue", {
                                path: "name",
                                type: new sap.extension.data.Alphanumeric({
                            ...
                            new sap.m.Toolbar("", { visible: false }),
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_costitem_activated") }),
                                        ...
                                        content: [
                                            new sap.ui.layout.form.SimpleForm("", {
                                                ...
                                                content: [
                                                    ...
                                                    new sap.m.Toolbar("", { visible: false }),
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_costitem_reference1") }),
                                                    new sap.extension.m.Input("", {
                                                    }).bindProperty("bindingValue", {
                                                        path: "reference1",
                                                        type: new sap.extension.data.Alphanumeric({
                                                    ...
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_costitem_reference2") }),
                                                    new sap.extension.m.Input("", {
                                                    }).bindProperty("bindingValue", {
                                                        path: "reference2",
                                                        type: new sap.extension.data.Alphanumeric({
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            new sap.m.Toolbar("", { visible: false }),
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_costitem_remarks") }),
                            new sap.extension.m.TextArea("", {
                                rows: 3,
                            }).bindProperty("bindingValue", {
                                path: "remarks",

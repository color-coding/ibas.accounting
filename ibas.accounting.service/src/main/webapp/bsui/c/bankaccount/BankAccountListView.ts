...
namespace accounting {
    export namespace ui {
        export namespace c {
            /** 列表视图-银行账户 */
            export class BankAccountListView extends ibas.BOListView implements app.IBankAccountListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                ...
                                template: new sap.extension.m.DataLink("", {
                                    objectCode: bo.BO_CODE_BANKACCOUNT
                    ...
                    return new sap.extension.m.Page("", {
                        ...
                        subHeader: new sap.m.Toolbar("", {
                            content: [
                                ...
                                new sap.m.ToolbarSeparator(""),
                                new sap.m.Button("", {
                                    text: ibas.i18n.prop("accounting_func_bank"),
                                    type: sap.m.ButtonType.Transparent,
                                    icon: "sap-icon://capital-projects",
                                    press: function (): void {
                                        that.fireViewEvents(that.bankEvent);
                                    }
                                }),

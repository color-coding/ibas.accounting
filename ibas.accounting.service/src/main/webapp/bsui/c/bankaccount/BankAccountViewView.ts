...
namespace accounting {
    export namespace ui {
        export namespace c {
            /** 查看视图-银行账户 */
            export class BankAccountViewView extends ibas.BOViewView implements app.IBankAccountViewView {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        headerTitle: new sap.uxap.ObjectPageHeader("", {
                            ...
                            actions: [
                                new sap.extension.m.ObjectYesNoStatus("", {
                                    title: ibas.i18n.prop("bo_bankaccount_activated"),
                                    enumValue: {
                                        path: "activated",
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectAttribute("", {
                                title: ibas.i18n.prop("bo_bankaccount_accounttype"),
                                bindingValue: {
                                    path: "accountType",
                                    type: new sap.extension.data.Alphanumeric(),
                                }

...
namespace accounting {
    export namespace app {
        /** 列表应用-分支 */
        export class BranchListApp extends ibas.BOListApplication<IBranchListView, bo.Branch> {
            /** 应用标识 */
            static APPLICATION_ID: string = "a3a511e0-b18e-4f51-8f72-e0aff729ae9f";
            /** 应用名称 */
            static APPLICATION_NAME: string = "accounting_app_branch_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Branch.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = BranchListApp.APPLICATION_ID;
                this.name = BranchListApp.APPLICATION_NAME;
                this.boCode = BranchListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.Branch): void {
                ...
                let app: BranchViewApp = new BranchViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.Branch | bo.Branch[]): void {
                let beDeleteds: ibas.IList<bo.Branch> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-分支 */
        export interface IBranchListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */

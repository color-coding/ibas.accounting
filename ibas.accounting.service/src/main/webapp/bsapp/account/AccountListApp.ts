...
namespace accounting {
    export namespace app {
        /** 列表应用-科目 */
        export class AccountListApp extends ibas.BOListApplication<IAccountListView, bo.Account> {
            /** 应用标识 */
            static APPLICATION_ID: string = "5daf7b73-0d21-4a63-9d1b-805d74e54d98";
            /** 应用名称 */
            static APPLICATION_NAME: string = "accounting_app_account_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Account.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = AccountListApp.APPLICATION_ID;
                this.name = AccountListApp.APPLICATION_NAME;
                this.boCode = AccountListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.Account): void {
                ...
                let app: AccountViewApp = new AccountViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.Account | bo.Account[]): void {
                let beDeleteds: ibas.IList<bo.Account> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-科目 */
        export interface IAccountListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */

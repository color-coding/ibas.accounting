...
namespace accounting {
    export namespace app {
        /** 列表应用-日记账分录 */
        export class JournalEntryListApp extends ibas.BOListApplication<IJournalEntryListView, bo.JournalEntry> {
            /** 应用标识 */
            static APPLICATION_ID: string = "6a3b514a-ac03-4310-bd38-9cb0b0acf35e";
            /** 应用名称 */
            static APPLICATION_NAME: string = "accounting_app_journalentry_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.JournalEntry.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = JournalEntryListApp.APPLICATION_ID;
                this.name = JournalEntryListApp.APPLICATION_NAME;
                this.boCode = JournalEntryListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.JournalEntry): void {
                ...
                let app: JournalEntryViewApp = new JournalEntryViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.JournalEntry | bo.JournalEntry[]): void {
                let beDeleteds: ibas.IList<bo.JournalEntry> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-日记账分录 */
        export interface IJournalEntryListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */

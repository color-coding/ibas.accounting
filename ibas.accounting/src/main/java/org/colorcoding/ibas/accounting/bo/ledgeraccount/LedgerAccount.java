...
@XmlType(name = LedgerAccount.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = LedgerAccount.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = LedgerAccount.BUSINESS_OBJECT_CODE)
public class LedgerAccount extends BusinessObject<LedgerAccount> implements ILedgerAccount {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 6581745484594810095L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = LedgerAccount.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OLDA";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_LACCOUNT";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "LedgerAccount";

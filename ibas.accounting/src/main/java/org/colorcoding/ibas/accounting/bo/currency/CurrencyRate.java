...
public class CurrencyRate extends BusinessObject<CurrencyRate> implements ICurrencyRate {
	 ...
	 * 货币 属性
	 */
	@DbField(name = "Currency", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 日期 属性
	 */
	@DbField(name = "Date", type = DataType.DATE, table = DB_TABLE_NAME, uniqueKey = true)

package org.colorcoding.ibas.accounting.bo.project;
...
@BusinessObjectUnit(code = Project.BUSINESS_OBJECT_CODE)
public class Project extends BusinessObject<Project>
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OPRJ";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_PROJECT";
	 ...
	 * 结束日期 属性
	 */
	@DbField(name = "CloseDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 项目经理 属性
	 */
	@DbField(name = "Manager", type = DataType.NUMERIC, table = DB_TABLE_NAME)

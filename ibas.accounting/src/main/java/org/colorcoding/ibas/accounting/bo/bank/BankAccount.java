...
@XmlType(name = BankAccount.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = BankAccount.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = BankAccount.BUSINESS_OBJECT_CODE)
public class BankAccount extends BusinessObject<BankAccount> implements IBankAccount, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -710632308447444554L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = BankAccount.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OBKC";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_BANKACONT";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "BankAccount";
	 ...
	 * 属性名称-开户支行
	 */
	private static final String PROPERTY_OPENINGBANK_NAME = "OpeningBank";

	/**
	 * 开户支行 属性
	 */
	@DbField(name = "OpenBank", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_OPENINGBANK = registerProperty(PROPERTY_OPENINGBANK_NAME,
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_OPENINGBANK_NAME)
	public final String getOpeningBank() {
		return this.getProperty(PROPERTY_OPENINGBANK);
	}
	 ...
	 * @param value 值
	 */
	public final void setOpeningBank(String value) {
		this.setProperty(PROPERTY_OPENINGBANK, value);
	}

	/**
	 * 属性名称-账户类型
	 */
	private static final String PROPERTY_ACCOUNTTYPE_NAME = "AccountType";

	/**
	 * 账户类型 属性
	 */
	@DbField(name = "AccountType", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_ACCOUNTTYPE = registerProperty(PROPERTY_ACCOUNTTYPE_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_ACCOUNTTYPE_NAME)
	public final String getAccountType() {
		return this.getProperty(PROPERTY_ACCOUNTTYPE);
	}
	...
	public final void setAccountType(String value) {
		this.setProperty(PROPERTY_ACCOUNTTYPE, value);
	}

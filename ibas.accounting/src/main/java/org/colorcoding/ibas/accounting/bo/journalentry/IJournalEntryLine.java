...
public interface IJournalEntryLine extends IBODocumentLine {
    ...
    * @param value 值
    */
    void setSystemDebit(BigDecimal value);
    ...
    * @param value 值
    */
    void setSystemCredit(BigDecimal value);
    ...
    * @param value 值
    */
    void setSystemCurrency(String value);
    ...
    * @param value 值
    */
    void setSystemRate(BigDecimal value);
    ...
    * @param value 值
    */
    void setLocalDebit(BigDecimal value);
    ...
    * @param value 值
    */
    void setLocalCredit(BigDecimal value);
    ...
    * @param value 值
    */
    void setLocalCurrency(String value);
    ...
    * @param value 值
    */
    void setLocalRate(BigDecimal value);
    ...
    * @param value 值
    */
    void setBaseTotal(BigDecimal value);

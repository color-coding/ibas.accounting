package org.colorcoding.ibas.accounting.bo.taxgroup;
...
public class TaxGroup extends BusinessObject<TaxGroup> implements ITaxGroup, IBOTagReferenced {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -699711715710332009L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = TaxGroup.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OTAG";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_TAXGROUP";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "TaxGroup";
	...
	public static final IPropertyInfo<emTaxGroupCategory> PROPERTY_CATEGORY = registerProperty(PROPERTY_CATEGORY_NAME,
			emTaxGroupCategory.class, MY_CLASS);
	...
	public final emTaxGroupCategory getCategory() {
	 ...
	 * @param value 值
	 */
	public final void setCategory(emTaxGroupCategory value) {
	...
	protected void initialize() {
		...
		this.setCategory(emTaxGroupCategory.OUTPUT);

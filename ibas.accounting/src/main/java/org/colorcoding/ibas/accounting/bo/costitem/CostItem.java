package org.colorcoding.ibas.accounting.bo.costitem;
...
@XmlType(name = CostItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = CostItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = CostItem.BUSINESS_OBJECT_CODE)
public class CostItem extends BusinessObject<CostItem>
		implements ICostItem, IBOSeriesKey, IBOTagDeleted, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 5072377661326114713L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = CostItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OCOI";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_COSTITEM";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "CostItem";
	 ...
	 * 排序码 属性
	 */
	@DbField(name = "Sorts", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 属性名称-开票内容
	 */
	private static final String PROPERTY_INVOICECONTENT_NAME = "InvoiceContent";

	/**
	 * 开票内容 属性
	 */
	@DbField(name = "InvContent", type = DataType.MEMO, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_INVOICECONTENT = registerProperty(PROPERTY_INVOICECONTENT_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_INVOICECONTENT_NAME)
	public final String getInvoiceContent() {
		return this.getProperty(PROPERTY_INVOICECONTENT);
	}
	 ...
	 * @param value 值
	 */
	public final void setInvoiceContent(String value) {
		this.setProperty(PROPERTY_INVOICECONTENT, value);
	}

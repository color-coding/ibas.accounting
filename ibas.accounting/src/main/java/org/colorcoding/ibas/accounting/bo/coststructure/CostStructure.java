...
public class CostStructure extends BusinessObject<CostStructure>
	 ...
	 * 主体类型 属性
	 */
	@DbField(name = "EntityType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 主体编码 属性
	 */
	@DbField(name = "EntityCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 预算可结转 属性
	 */
	@DbField(name = "Transferable", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)

...
@XmlType(name = Bank.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Bank.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = Bank.BUSINESS_OBJECT_CODE)
public class Bank extends BusinessObject<Bank> implements IBank, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 8449294518495956412L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Bank.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OBAK";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_BANK";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Bank";
	 ...
	 * 属性名称-标识符
	 */
	private static final String PROPERTY_SWIFTCODE_NAME = "SwiftCode";

	/**
	 * 标识符 属性
	 */
	@DbField(name = "SwiftCode", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_SWIFTCODE = registerProperty(PROPERTY_SWIFTCODE_NAME,
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_SWIFTCODE_NAME)
	public final String getSwiftCode() {
		return this.getProperty(PROPERTY_SWIFTCODE);
	}
	 ...
	 * @param value 值
	 */
	public final void setSwiftCode(String value) {
		this.setProperty(PROPERTY_SWIFTCODE, value);
	}

...
public class Currency extends BusinessObject<Currency> implements ICurrency, IBusinessLogicsHost {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 5230882788473383908L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Currency.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OCRN";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_CURRENCY";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Currency";
	 ...
	 * 系统币 属性
	 */
	@DbField(name = "System", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 本币 属性
	 */
	@DbField(name = "Local", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * ISO代码 属性
	 */
	@DbField(name = "ISO", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_ISO = registerProperty(PROPERTY_ISO_NAME, String.class,
			MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_ISO_NAME)
	public final String getISO() {
		return this.getProperty(PROPERTY_ISO);
	}
	...
	public final void setISO(String value) {
		this.setProperty(PROPERTY_ISO, value);
	}

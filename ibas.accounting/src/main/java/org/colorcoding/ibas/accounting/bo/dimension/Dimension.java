package org.colorcoding.ibas.accounting.bo.dimension;
...
public class Dimension extends BusinessObject<Dimension> implements IDimension, IBusinessLogicsHost {
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_ODIM";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_DIMENSION";
	 ...
	 * 来源 属性
	 */
	@DbField(name = "Source", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)

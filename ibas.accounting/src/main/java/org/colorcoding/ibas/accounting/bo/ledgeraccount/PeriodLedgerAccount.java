...
public class PeriodLedgerAccount extends BusinessObject<PeriodLedgerAccount> implements IPeriodLedgerAccount {
	 ...
	 * 期间 属性
	 */
	@DbField(name = "Period", type = DataType.NUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 分类 属性
	 */
	@DbField(name = "Ledger", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)

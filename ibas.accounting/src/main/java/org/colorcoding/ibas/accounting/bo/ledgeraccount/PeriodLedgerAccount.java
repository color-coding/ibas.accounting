...
@XmlType(name = PeriodLedgerAccount.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = PeriodLedgerAccount.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = PeriodLedgerAccount.BUSINESS_OBJECT_CODE)
public class PeriodLedgerAccount extends BusinessObject<PeriodLedgerAccount> implements IPeriodLedgerAccount {
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PeriodLedgerAccount.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OPLA";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PeriodLedgerAccount";
	 ...
	 * 期间 属性
	 */
	@DbField(name = "Period", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-分类
	 */
	private static final String PROPERTY_LEDGER_NAME = "Ledger";

	/**
	 * 分类 属性
	 */
	@DbField(name = "Ledger", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	public static final IPropertyInfo<String> PROPERTY_LEDGER = registerProperty(PROPERTY_LEDGER_NAME, String.class,
			MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_LEDGER_NAME)
	public final String getLedger() {
		return this.getProperty(PROPERTY_LEDGER);
	}
	 ...
	 * @param value 值
	 */
	public final void setLedger(String value) {
		this.setProperty(PROPERTY_LEDGER, value);
	}

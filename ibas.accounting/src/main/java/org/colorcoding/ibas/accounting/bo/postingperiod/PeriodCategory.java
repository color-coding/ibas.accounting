...
@XmlType(name = PeriodCategory.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = PeriodCategory.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = PeriodCategory.BUSINESS_OBJECT_CODE)
public class PeriodCategory extends BusinessObject<PeriodCategory> implements IPeriodCategory {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 178406878253495555L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PeriodCategory.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AC_OPCG";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_AC_CATEGORY";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PeriodCategory";
	 ...
	 * 起始日期 属性
	 */
	@DbField(name = "StartDate", type = DbFieldType.DATE, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * 结束日期 属性
	 */
	@DbField(name = "EndDate", type = DbFieldType.DATE, table = DB_TABLE_NAME, primaryKey = false)
